...
static std::string llama_model_ftype_name(llama_ftype ftype) {
    ...
    switch (ftype) {
        ...
        case LLAMA_FTYPE_MOSTLY_ISO4:     return "ISO4";
        case LLAMA_FTYPE_MOSTLY_ROTOR4:   return "ROTOR4";
...
llama_model_loader::llama_model_loader(
    ...
    // TODO: make optional
    {
        ...
        switch (type_max) {
            ...
            case GGML_TYPE_ISO4:    ftype = LLAMA_FTYPE_MOSTLY_ISO4;    break;
            case GGML_TYPE_ROTOR4:   ftype = LLAMA_FTYPE_MOSTLY_ROTOR4;   break;
            default:
                {
