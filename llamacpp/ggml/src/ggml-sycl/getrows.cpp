...
void ggml_sycl_op_get_rows(ggml_backend_sycl_context & ctx, ggml_tensor * dst) {
    ...
    switch (dst->src[0]->type) {
        ...
        case GGML_TYPE_Q8_0:
            ...
            break;
        case GGML_TYPE_ISO4:
            get_rows_sycl<32, 2, dequantize_iso4>(ctx, dst->src[0], dst->src[1], dst, (const float *)dst->src[0]->data,
            src1_i32, (float *)dst->data, ctx.stream());
            break;
        case GGML_TYPE_ROTOR4:
            get_rows_sycl<32, 2, dequantize_rotor4>(ctx, dst->src[0], dst->src[1], dst, (const float *)dst->src[0]->data,
            src1_i32, (float *)dst->data, ctx.stream());
            break;
        default:
            // TODO: k-quants
