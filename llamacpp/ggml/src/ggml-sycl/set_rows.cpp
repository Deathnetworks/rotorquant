...
static void set_rows_sycl_q(const char * __restrict__ src0_d,
    ...
    stream->parallel_for(sycl::nd_range<1>(grid_size * block_size, block_size), [=](sycl::nd_item<1> item_ct1) {
        ...
        cpyblck(src_block, dst_block, i00 / qk);
    });
    GGML_UNUSED(ne10);
    GGML_UNUSED(ne13);
    GGML_UNUSED(nb00);
...
static void set_rows_sycl(ggml_backend_sycl_context & ctx, const ggml_tensor * src0, const ggml_tensor * src1, ggml_tensor * dst) {
    ...
    switch (dst->type) {
        ...
        case GGML_TYPE_IQ4_NL:
            ...
            break;
        case GGML_TYPE_ISO4:
            set_rows_sycl_q<TIdx, block_iso4, 32, cpy_blck_f32_iso4>(src0_d, src1_d, (block_iso4 *)dst->data, ne00, ne01, ne02, ne03, ne10, ne11, ne12, ne13, nb00, nb01, nb02, nb03, nb10, nb11, nb12, nb13, nb1, nb2, nb3, stream);
            break;
        case GGML_TYPE_ROTOR4:
            set_rows_sycl_q<TIdx, block_rotor4, 32, cpy_blck_f32_rotor4>(src0_d, src1_d, (block_rotor4 *)dst->data, ne00, ne01, ne02, ne03, ne10, ne11, ne12, ne13, nb00, nb01, nb02, nb03, nb10, nb11, nb12, nb13, nb1, nb2, nb3, stream);
            break;
