...
GGML_API void quantize_row_iso4_ref   (const float * GGML_RESTRICT x, block_iso4    * GGML_RESTRICT y, int64_t k);
GGML_API void quantize_row_rotor4_ref (const float * GGML_RESTRICT x, block_rotor4   * GGML_RESTRICT y, int64_t k);
...
GGML_API void dequantize_row_iso4(const block_iso4 * GGML_RESTRICT x, float * GGML_RESTRICT y, int64_t k);
GGML_API void dequantize_row_rotor4(const block_rotor4 * GGML_RESTRICT x, float * GGML_RESTRICT y, int64_t k);
...
GGML_API size_t quantize_iso4(const float * GGML_RESTRICT src, void * GGML_RESTRICT dst, int64_t nrows, int64_t n_per_row, const float * imatrix);
GGML_API size_t quantize_rotor4(const float * GGML_RESTRICT src, void * GGML_RESTRICT dst, int64_t nrows, int64_t n_per_row, const float * imatrix);
