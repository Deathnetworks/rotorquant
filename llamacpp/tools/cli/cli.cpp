...
int main(int argc, char ** argv) {
    ...
    common_init();
    fprintf(stderr, "CLI: main started\n"); fflush(stderr);
    fprintf(stderr, "CLI: creating common_params\n"); fflush(stderr);

    if (!common_params_parse(argc, argv, params, LLAMA_EXAMPLE_CLI)) {
        fprintf(stderr, "CLI: common_params_parse failed\n"); fflush(stderr);
        return 1;
    }
    fprintf(stderr, "CLI: common_params_parse done\n"); fflush(stderr);
    ...
    fprintf(stderr, "llama_backend_init: start\n"); fflush(stderr);
    llama_backend_init();
    fprintf(stderr, "llama_numa_init: start\n"); fflush(stderr);
